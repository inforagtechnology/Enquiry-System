...
import React, { useState } from "react";
import API from "../component/API"; //  THE FIX: Import your custom API instance instead of raw axios
import { ToastContainer, toast } from "react-toastify";
import "react-toastify/dist/ReactToastify.css";
// import "./RegistrationForm.css";
import sideImage from "./images/registerside.jpg";
...
const RegistrationForm = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    // Clean up input spacing fields to avoid regex validation errors on backend
    const cleanedForm = {
      ...form,
      name: form.name.trim(),
    ...
    try {
      //  THE FIX: Change path from '/registration/register' to '/codeofschool/register'
      // Use your imported API instance directly without string templates
      const response = await API.post("/registration/register", cleanedForm);
